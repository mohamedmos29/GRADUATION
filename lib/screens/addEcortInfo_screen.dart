...
class _AddEscortInfoState extends State<AddEscortInfo> {
  ...
  TextEditingController YourHandelController = TextEditingController();
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: ListView(children: [
              ...
              TextFieldComponent(
                controlleR: YourHandelController,
                validate: (value) {
                  if (value!.isEmpty) {
                    return 'Please enter YourHandel';
                  }
                  bool emailValid = RegExp(
                          r"^[a-zA-Z0-9.a-zA-Z0-9.!#$%&'*+-/=?^_`{|}~]+@[a-zA-Z0-9]+\.[a-zA-Z]+")
                      .hasMatch(value);
                  if (!emailValid) {
                    'Enter Valid YourHandel';
                  }
                  return null;
                },
                labelText: 'Your Handel',
                inputType: TextInputType.name,
              ...
              ButtonComponent(
                () {
                  if (formKey.currentState!.validate()) {
                    ...
                    print(YourHandelController.text);
